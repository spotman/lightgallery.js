/**!
 * lightgallery.js | 1.1.3 | June 20th 2019
...
(function (global, factory) {
    ...
    Plugin.prototype.structure = function () {
        ...
        template = '<div class="lg-outer ' + this.s.addClass + ' ' + this.s.startClass + '">' + '<div class="lg">' + '<div class="lg-inner">' + list + '</div>' + '<div class="lg-toolbar group">' + '<span class="lg-close lg-icon"></span>' + '</div>' + controls + subHtmlCont + '</div>' + '</div>';
